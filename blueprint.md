...
*   **المنصة:** يتم استضافة الموقع على **Firebase Hosting** لضمان أعلى أداء وسرعة.
*   **النشر التلقائي:** تم إعداد GitHub Actions لنشر الموقع تلقائيًا على Firebase عند أي تحديث على الفرع `main`.
