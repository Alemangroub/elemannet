import{o as T,w as $,d,a as p,c as y,b as w}from"./client.02t19jQd.js";T(w,n=>{n||(window.location.href="/admin")});const v=document.getElementById("unitType"),g=document.getElementById("other-unit-type-group"),h=document.getElementById("otherUnitType");v.addEventListener("change",()=>{v.value==="other"?(g.style.display="block",h.required=!0):(g.style.display="none",h.required=!1)});const c=document.getElementById("installmentsCount"),m=document.getElementById("totalAmount"),E=document.getElementById("installments-container");function f(){const n=parseInt(c.value)||0,o=parseFloat(m.value)||0;if(E.innerHTML="",n>0){const l=(o/n).toFixed(2);for(let t=1;t<=n;t++){const s=document.createElement("div");s.className="installment-entry";const e=new Date;e.setDate(e.getDate()+1),e.setMonth(e.getMonth()+(t-1));const u=e.toISOString().split("T")[0];s.innerHTML=`
